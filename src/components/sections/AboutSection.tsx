  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[4%] left-[1%] sm:left-[2%] md:left-[4%] z-0 pointer-events-none">
        <FadeIn delay={0.1} x={-80} y={0} duration={0.9}>
          <img
            ...
            alt="3D Moon Icon"
            className="w-[120px] sm:w-[160px] md:w-[210px] h-auto object-contain drop-shadow-xl select-none"
            draggable={false}
          />
        </FadeIn>
      </div>
      ...
      <div className="absolute bottom-[8%] left-[3%] sm:left-[6%] md:left-[10%] z-0 pointer-events-none">
        <FadeIn delay={0.25} x={-80} y={0} duration={0.9}>
          <img
            ...
            className="w-[100px] sm:w-[140px] md:w-[180px] h-auto object-contain drop-shadow-xl select-none"
            draggable={false}
          />
        </FadeIn>
      </div>
      ...
      <div className="absolute bottom-[8%] right-[3%] sm:right-[6%] md:right-[10%] z-0 pointer-events-none">
        <FadeIn delay={0.3} x={80} y={0} duration={0.9}>
          <img
            ...
            className="w-[130px] sm:w-[170px] md:w-[220px] h-auto object-contain drop-shadow-xl select-none"
            draggable={false}
          />
        </FadeIn>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto w-full">
        ...
        {/* Space between heading and animated text */}
        <div className="h-10 sm:h-14 md:h-16" />

        {/* Character-by-character scroll animated text */}
        <AnimatedText text={bioText} />

        {/* Space between animated text and button */}
